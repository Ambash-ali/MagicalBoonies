...
const Amboseli: React.FC = () => {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        // Fetch packages from Supabase where destinationCategory is 'Amboseli'
        const { data, error } = await supabase
          .from('safari_packages')
          .select('*')
          .eq('destination_category', 'Amboseli');
  ...
  return (
    <>
      <Helmet>
        <title>Amboseli Safaris | MagicalBoonies</title>
        <meta 
          name="description" 
          content="Experience the majestic elephants of Amboseli against the backdrop of Mt. Kilimanjaro. Luxury safari packages with expert guides and photographers."
        />
      </Helmet>
      ...
      <div className="relative h-screen w-full overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://magicalboonies.wordpress.com/wp-content/uploads/2023/07/shutterstock_1281067165_.jpg)'
          }}
        >
          ...
          <Container>
            <div className="max-w-3xl">
              <div className="flex items-center space-x-2 text-amber-400 mb-4">
                <MapPin size={20} />
                <span className="text-white font-medium">Amboseli National Park, Kenya</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white mb-6">
                Amboseli Safaris
              </h1>
              <p className="text-xl text-white mb-8 max-w-2xl">
                Where majestic elephants roam beneath the snow-capped peak of Mt. Kilimanjaro, creating Africa's most iconic views.
              </p>
            </div>
          </Container>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-600 mb-6">
                Crowned by Mount Kilimanjaro, Africa's highest peak, Amboseli National Park is one of Kenya's most popular tourist parks. The name "Amboseli" comes from a Maasai word meaning "salty dust", and it is one of the best places in Africa to view large herds of elephants up close.
              </p>
              <p className="text-gray-600 mb-6">
                The park is famous for being the best place in the world to get close to free-ranging elephants. Other attractions of the park include opportunities to meet the Maasai people and spectacular views of Mount Kilimanjaro when the weather is clear.
              </p>
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6 mt-8">
                <div className="bg-amber-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-2">
                    ...
                    <li className="flex items-center">
                      <Calendar size={18} className="text-amber-600 mr-2" />
                      <span>Clear Kilimanjaro Views: Early Morning</span>
                    </li>
                    <li className="flex items-center">
                      <Calendar size={18} className="text-amber-600 mr-2" />
                      <span>Green Season: March - May</span>
                    </li>
                  </ul>
                </div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Southern Kenya</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">392 square kilometers</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">45-minute flight or 4-hour drive from Nairobi</p>
                    </div>
                  </li>
                </ul>
      ...
      {/* Safari Packages Section - Matching the Masai Mara layout */}
        ...
        <div className="text-center py-16">
          <Container>
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Experience the iconic views of Mt. Kilimanjaro and majestic elephants with our specialized safari packages
            </p>
          </Container>
        </div>
          ...
          <>
            {packages.length === 0 ? (
              <Container className="text-center py-12">
                <p className="text-gray-600">No packages available for Amboseli at the moment.</p>
              </Container>
            ) : (
                  ...
                  <Container className="py-16 lg:py-24 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
                      ...
                      <div className="flex flex-col justify-center md:order-2">
                        ...
                        <p className="text-gray-600 mb-6 leading-relaxed">{pkg.overview || 'Experience the stunning wilderness of Amboseli with this safari package.'}</p>
