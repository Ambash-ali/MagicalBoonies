...
const Tsavo: React.FC = () => {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        // Fetch packages from Supabase where destinationCategory is 'Tsavo'
        const { data, error } = await supabase
          .from('safari_packages')
          .select('*')
          .eq('destination_category', 'Tsavo');
  ...
  return (
    <>
      <Helmet>
        <title>Tsavo Safaris | MagicalBoonies</title>
        <meta 
          name="description" 
          content="Experience Kenya's largest national park with our Tsavo safari packages. See the famous red elephants, diverse wildlife, and stunning landscapes."
        />
      </Helmet>
      ...
      <div className="relative h-screen w-full overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://magicalboonies.wordpress.com/wp-content/uploads/2023/07/wallpaperflare.com_wallpaper-1-1.jpg)'
          }}
        >
          ...
          <Container>
            <div className="max-w-3xl">
              <div className="flex items-center space-x-2 text-amber-400 mb-4">
                <MapPin size={20} />
                <span className="text-white font-medium">Tsavo National Parks, Kenya</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white mb-6">
                Tsavo Safaris
              </h1>
              <p className="text-xl text-white mb-8 max-w-2xl">
                Discover Kenya's largest wilderness area, home to the famous red elephants and diverse landscapes from volcanic hills to crystal-clear springs.
              </p>
            </div>
          </Container>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-600 mb-6">
                Tsavo National Park, divided into East and West, is Kenya's largest national park system and one of the world's largest wildlife sanctuaries. Famous for its red elephants, the park offers diverse landscapes from rivers and natural springs to volcanic hills.
              </p>
              <p className="text-gray-600 mb-6">
                The park is home to the famous Man-Eaters of Tsavo lions, large herds of elephants, and a rich variety of wildlife including rhinos, buffalos, giraffes, and numerous bird species. The crystal-clear waters of Mzima Springs and the volcanic landscapes add to its unique appeal.
              </p>
                ...
                <div className="bg-amber-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-center">
                      ...
                      <span>Peak Season: June - October</span>
                    </li>
                    <li className="flex items-center">
                      <Calendar size={18} className="text-amber-600 mr-2" />
                      <span>Migration Period: July - August</span>
                    </li>
                    <li className="flex items-center">
                      <Calendar size={18} className="text-amber-600 mr-2" />
                      <span>Green Season: November - December</span>
                    </li>
                  </ul>
                </div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Southeastern Kenya</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">21,000 square kilometers</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">5-6 hours drive from Nairobi or 1-hour flight</p>
                    </div>
                  </li>
                </ul>
      ...
      {/* Safari Packages Section - Matching the Samburu layout */}
        ...
        <div className="text-center py-16">
          <Container>
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Experience Kenya's largest wilderness area with our specialized safari packages
            </p>
          </Container>
        </div>
          ...
          <>
            {packages.length === 0 ? (
              <Container className="text-center py-12">
                <p className="text-gray-600">No packages available for Tsavo at the moment.</p>
              </Container>
            ) : (
                  ...
                  <Container className="py-16 lg:py-24 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
                      ...
                      <div className="flex flex-col justify-center md:order-2">
                        ...
                        <p className="text-gray-600 mb-6 leading-relaxed">{pkg.overview || 'Experience the stunning wilderness of Tsavo with this safari package.'}</p>
