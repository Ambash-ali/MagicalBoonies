...
const LakeNakuru: React.FC = () => {
  ...
  useEffect(() => {
    const fetchPackages = async () => {
      try {
        // Fetch packages from Supabase where destinationCategory is 'Lake Nakuru'
        // Updated to match the correct field name from the sfp.ts type definition
        const { data, error } = await supabase
          .from('safari_packages')
          .select('*')
          .eq('destination_category', 'Lake Nakuru');
  ...
  return (
    <>
      <Helmet>
        <title>Lake Nakuru Safaris | MagicalBoonies</title>
        <meta 
          name="description" 
          content="Experience the stunning flamingo-filled Lake Nakuru with our specialized safari packages. See rhinos, diverse bird species, and the famous pink shores."
        />
      </Helmet>
      ...
      <div className="relative h-screen w-full overflow-hidden">
        <div 
          ...
          style={{
            backgroundImage: 'url(https://magicalboonies.wordpress.com/wp-content/uploads/2023/07/pink-flamingos-lake-nakuru.jpg)'
          }}
        >
          ...
          <Container>
            <div className="max-w-3xl">
              <div className="flex items-center space-x-2 text-amber-400 mb-4">
                <MapPin size={20} />
                <span className="text-white font-medium">Lake Nakuru National Park, Kenya</span>
              </div>
              <h1 className="text-4xl md:text-5xl lg:text-6xl font-serif font-bold text-white mb-6">
                Lake Nakuru Safaris
              </h1>
              <p className="text-xl text-white mb-8 max-w-2xl">
                Witness the spectacular sight of thousands of flamingos painting the shores pink, alongside diverse wildlife including rhinos and over 450 bird species.
              </p>
            </div>
          </Container>
        </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
            <div className="lg:col-span-2">
              ...
              <p className="text-gray-600 mb-6">
                Lake Nakuru National Park is a UNESCO World Heritage Site famous for its large flocks of flamingos that paint the lake shores pink. The park is also a sanctuary for both black and white rhinos, making it one of the best places in Kenya to spot these endangered species.
              </p>
              <p className="text-gray-600 mb-6">
                Beyond the flamingos, the park hosts over 450 bird species and a variety of wildlife including lions, leopards, hippos, and Rothschild's giraffes. The lake's alkaline waters and surrounding woodlands create diverse ecosystems that support this rich biodiversity.
              </p>
                ...
                <div className="bg-amber-50 p-6 rounded-lg">
                  ...
                  <ul className="space-y-2">
                    <li className="flex items-center">
                      ...
                      <span>Peak Flamingo Season: June - September</span>
                    </li>
                    <li className="flex items-center">
                      <Calendar size={18} className="text-amber-600 mr-2" />
                      <span>Dry Season: June - March</span>
                    </li>
                    <li className="flex items-center">
                      <Calendar size={18} className="text-amber-600 mr-2" />
                      <span>Bird Migration: November - April</span>
                    </li>
                  </ul>
                </div>
                ...
                <ul className="space-y-4">
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">Rift Valley, Kenya</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">188 square kilometers</p>
                    </div>
                  </li>
                  <li className="flex items-start">
                    ...
                    <div>
                      ...
                      <p className="text-gray-600">3-hour drive from Nairobi or 30-minute flight</p>
                    </div>
                  </li>
                </ul>
        ...
        <div className="text-center py-16">
          <Container>
            ...
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Experience the beauty of Lake Nakuru with our specialized safari packages
            </p>
          </Container>
        </div>
          ...
          <>
            {packages.length === 0 ? (
              <Container className="text-center py-12">
                <p className="text-gray-600">No packages available for Lake Nakuru at the moment.</p>
              </Container>
            ) : (
              packages.map((pkg, index) => (
                ...
                >
                  ...
                  <div 
                    ...
                    style={{
                      background: `radial-gradient(circle at ${index % 2 !== 0 ? '70%' : '30%'} 50%, rgb(236 72 153 / 0.2), transparent 70%)`,
                    }}
                  />
                  ...
                  <Container className="py-16 lg:py-24 relative z-10">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 lg:gap-16 items-center">
                      ...
                      <div className="flex flex-col justify-center md:order-2">
                        ...
                        <p className="text-gray-600 mb-6 leading-relaxed">{pkg.overview || 'Experience the stunning wilderness of Lake Nakuru with this safari package.'}</p>
